...
public abstract class AxisRenderer extends Renderer {
    ...
    protected Paint mGridPaintTransparentColor;
    ...
    public AxisRenderer(ViewPortHandler viewPortHandler, Transformer trans, AxisBase axis) {
        ...
        if(mViewPortHandler != null) {
            ...
            mGridPaintTransparentColor = new Paint();
            mGridPaintTransparentColor.setColor(Color.RED);
            mGridPaintTransparentColor.setStrokeWidth(1f);
            mGridPaintTransparentColor.setStyle(Style.STROKE);
            mGridPaintTransparentColor.setAlpha(90);
