...
public class IndicatorAdapter extends RecyclerView.Adapter<IndicatorAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        if (pos >= position) {
            ...
            gradientDrawable.setColor(holder.itemView.getContext().getResources().getColor(R.color.colorAccent));
        } else {
            GradientDrawable gradientDrawable = (GradientDrawable) holder.viewIndicator.getBackground();
            gradientDrawable.setColor(holder.itemView.getContext().getResources().getColor(R.color.colorAccentLight));
        }
    }
