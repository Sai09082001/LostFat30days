...
public class SectionAdapter extends ListAdapter<SectionUser, SectionAdapter.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        void bind(SectionUser section) {
            ...
            if(idLevel==1){
                ivLevel1.setColorFilter(ContextCompat.getColor(mContext, R.color.colorPrimary));
            }else if(idLevel==2){
                ivLevel1.setColorFilter(ContextCompat.getColor(mContext, R.color.colorPrimary));
                ivLevel2.setColorFilter(ContextCompat.getColor(mContext, R.color.colorPrimary));
            }else if(idLevel==3){
                ivLevel1.setColorFilter(ContextCompat.getColor(mContext, R.color.colorPrimary));
                ivLevel2.setColorFilter(ContextCompat.getColor(mContext, R.color.colorPrimary));
                ivLevel3.setColorFilter(ContextCompat.getColor(mContext, R.color.colorPrimary));
            }
