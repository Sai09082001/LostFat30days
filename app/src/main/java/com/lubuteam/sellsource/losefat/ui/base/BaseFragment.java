...
public abstract class BaseFragment extends Fragment {
    ...
    protected void popFragment(String TAG, int flag) {
        if (null != TAG) {
            Objects.requireNonNull(getActivity()).getSupportFragmentManager().popBackStack(TAG, flag);
        } else {
    ...
    protected Fragment findFragment(String TAG) {
        return Objects.requireNonNull(getActivity()).getSupportFragmentManager().findFragmentByTag(TAG);
    }
