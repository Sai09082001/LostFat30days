...
import com.lubuteam.sellsource.losefat.ui.fragments.DailyListFragment;
import com.lubuteam.sellsource.losefat.ui.fragments.ListTrainingFragment;
...
public class CardFragment extends BaseFragment {
    ...
    protected void initViews() {
        ...
        if (position == 1) {
            ...
            ivLevel1.setColorFilter(ContextCompat.getColor(getContext(), R.color.colorPrimary));
            ...
            ivLevel1.setColorFilter(ContextCompat.getColor(getContext(), R.color.colorPrimary));
            ivLevel2.setColorFilter(ContextCompat.getColor(getContext(), R.color.colorPrimary));
            ...
            ivLevel1.setColorFilter(ContextCompat.getColor(getContext(), R.color.colorPrimary));
            ivLevel2.setColorFilter(ContextCompat.getColor(getContext(), R.color.colorPrimary));
            ivLevel3.setColorFilter(ContextCompat.getColor(getContext(), R.color.colorPrimary));
