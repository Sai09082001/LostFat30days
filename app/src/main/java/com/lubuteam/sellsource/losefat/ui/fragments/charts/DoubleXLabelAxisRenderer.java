package com.lubuteam.sellsource.losefat.ui.fragments.charts;
...
//        }
    ...
    public void renderGridLines(Canvas c) {
        ...
        for (int i = 0; i < positions.length; i += 2) {
            drawGridLine(c, positions[i], positions[i + 1], gridLinePath, mGridPaint);
        }

        c.restoreToCount(clipRestoreCount);
    }

    protected void drawGridLine(Canvas c, float x, float y, Path gridLinePath, Paint paint) {
