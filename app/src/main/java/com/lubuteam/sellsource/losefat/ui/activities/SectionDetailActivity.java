...
import com.lubuteam.sellsource.losefat.data.repositories.ChallengeRepository;
...
import com.lubuteam.sellsource.losefat.ui.adapters.WorkoutAdapter;
...
//                    Log.e("status", "loadlist");
    ...
    private void initToolbar() {
        ...
        if (sectionUser.getData().getType() == 0) {
            ((TextView) findViewById(R.id.txt_title)).setText(sectionUser.getData().getTitleDisplay().toUpperCase());
