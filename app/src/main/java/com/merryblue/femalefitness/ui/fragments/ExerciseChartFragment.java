...
import com.merryblue.femalefitness.ui.fragments.charts.StickyDateAxisValueFormatter;
import com.merryblue.femalefitness.ui.fragments.charts.YAxisValueFormatter;
...
public class ExerciseChartFragment extends BaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_exercise_chart, container, false);
        initViews();
        initObservers();
        initEvents();
        loadData();
    ...
    private void loadData() {
        addDisposable(DayHistoryRepository.getInstance().getAllExercises()
                .subscribe(response -> {
...
//        Log.e("status", list.toString());
        ...
        for (DayHistoryModel dayHistoryModel : list) {
            data.add(new BarEntry(dayHistoryModel.getDayCount(), dayHistoryModel.getExercises()));
        }
        initYAxis();
        setEntry(data);
    }
