...
public class PorterShapeImageView extends PorterImageView {
    ...
    private Drawable shapeOff;
    private Drawable shapeOn;
    ...
    private void setup(Context context, AttributeSet attrs, int defStyle) {
        if (attrs != null) {
            ...
            shapeOn = typedArray.getDrawable(R.styleable.PorterShapeImageView_siShape);
            shapeOff = typedArray.getDrawable(R.styleable.PorterShapeImageView_siShapeOff);
            shape = shapeOff;
            typedArray.recycle();
        }
        matrix = new Matrix();
    ...
    public void switchState(Boolean isChecked) {
        if (isChecked) {
            shape = shapeOn;
        } else {
            shape = shapeOff;
